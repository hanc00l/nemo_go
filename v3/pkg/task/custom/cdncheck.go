...
var cdns = []string{
	...
	"131.0.72.0/22", "120.221.136.0/24", "119.188.132.0/24", "115.127.235.0/24", "42.236.6.0/24", "125.88.190.0/24",
	"61.54.47.0/24", "103.27.12.0/22", "116.193.80.0/21", "101.79.159.0/24", "123.155.158.0/24", "111.47.226.0/24",
...
func (c *CDNCheck) Check(domain string) (isCDN bool, CDNName string, CName string) {
	if utils.CheckIP(domain) {
		if c.CheckIP(domain) || c.CheckASN(domain) {
			isCDN = true
		}
	} else {
